    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
        <div class="col-span-full lg:col-span-1">
          <a class="flex-none text-xl font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#" aria-label="Brand">ShopEase</a>
        </div>
        <!-- End Col -->

        <div class="col-span-1">
          <h4 class="text-white font-semibold text-gray-100">Product</h4>
        ...
        <div class="col-span-1">
          <h4 class=" text-white font-semibold text-gray-100">Company</h4>
        ...
        <div class="col-span-2">
          <h4 class="text-white font-semibold text-gray-100">Stay up to date</h4>
