                ...
                <div class="w-full mb-8 md:w-1/2 md:mb-0">
                    <div class="sticky top-0 z-50 overflow-hidden">
                        <div class="relative mb-6 lg:mb-10 lg:h-2/4">
                            <!-- Image Display -->
                            <img src="{{url('storage', $products->images[0])}}" alt="" class="object-cover w-full lg:h-full">
                        </div>
                    ...
                    <div class="lg:pl-20">
                        ...
                        <div class="flex flex-wrap items-center gap-4">
                            <button wire:click="addToCart({{$products->id}})" class="w-full p-4 bg-blue-500 rounded-md lg:w-2/5 dark:text-gray-200 text-gray-50 hover:bg-blue-600 dark:bg-blue-500 dark:hover:bg-blue-700">
                                <span wire:loading.remove wire:target="addToCart({{$products->id}})">Add to cart</span>
                                <span wire:loading wire:target="addToCart({{$products->id}})">Adding ...</span>
                            </button>
                        </div>
                    </div>
                </div>
